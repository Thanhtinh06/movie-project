import slide1 from "../assets/images/gai-gia-lam-chieu_gp09.jpg";
import slide2 from "../assets/images/lua-deu-gap-lua-dao_gp09.jpg";
import slide3 from "../assets/images/than-bip-jack-chot_gp09.jpg";

import React from "react";

const Carousel = () => {
  return (
<div id="default-carousel" className="relative w-full mt-[87px]" data-carousel="slide">
  {/* Carousel wrapper */}
  <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
    {/* Item 1 */}
    <div className="duration-700 ease-in-out" data-carousel-item>
      <img src={slide1} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="slide1" />
    </div>
    {/* Item 2 */}
    <div className="duration-700 ease-in-out" data-carousel-item>
      <img src={slide2} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="slide2" />
    </div>
    {/* Item 3 */}
    <div className="duration-700 ease-in-out" data-carousel-item>
      <img src={slide3} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="slide3" />
    </div>
  </div>
  {/* Slider indicators */}
